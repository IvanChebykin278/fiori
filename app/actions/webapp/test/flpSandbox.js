		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Actions",
									"targetURL": "#fioriactions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriactions-display": {
								"semanticObject": "fioriactions",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.actions",
									"url": sap.ui.require.toUrl("fiori/actions")
								}
							}
						}
					}
