		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fiorisemanticobjects-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorisemanticobjects-display": {
								"semanticObject": "fiorisemanticobjects",
								"action": "display",
								"description": "Semantic objects desc",
								"title": "Semantic objects",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori.semanticobjects",
									"url": sap.ui.require.toUrl("fiori/semanticobjects")
								}
							}
						}
					}
