sap.ui.define([
		...
		return BaseObject.extend("master.detail.tree.app.masterDetailDclname.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias master.detail.tree.app.masterDetailDclname.controller.ListSelector
			 */
